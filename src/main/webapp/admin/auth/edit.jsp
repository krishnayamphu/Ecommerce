        ...
        <div class="card-body register-card-body">
            ...
            <form action="edit" method="post">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control" name="firstname" value="${admin.firstname}" placeholder="First Name">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control" name="lastname" value="${admin.lastname}" placeholder="Last Name">
                    <div class="input-group-append">
                        <div class="input-group-text">
                            <span class="fas fa-user"></span>
                        </div>
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control" name="contact" value="${admin.contact}" placeholder="Contact">
                    <div class="input-group-append">
                        <div class="input-group-text">
...
<!-- AdminLTE App -->
<script src="http://localhost:8080/ecommerce/dist/js/adminlte.min.js"></script>
</body>
</html>
